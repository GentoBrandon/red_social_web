...
router.get('/get-request-friend-by-id/:id', RequestFriendController.getRequestById);
router.put('/update-request-friend/:id', RequestFriendController.updateRequest);
router.delete('/delete-request-friend/:id', RequestFriendController.deleteRequest); 
