...
export default class FriendStatusController {
  static async createFriendStatus(
    req: Request,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
    try {
      ...
      const resultInsert = await FriendStatusService.insertStatus(
        data.name_status,
      );
  ...
  static async getAllFriendStatus(
    req: Request,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
  ...
  static async findFriendStatusById(
    req: Request,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
  ...
  static async updateFriendStatus(
    ...
    try {
      ...
      const resultUpdate = await FriendStatusService.updateStatus(
        _id,
        name_status,
      );
  ...
  static async deleteFriendStatus(
    req: Request,
    res: Response,
    next: NextFunction,
  ): Promise<void> {
