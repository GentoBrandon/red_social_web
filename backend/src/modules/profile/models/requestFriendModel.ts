...
export class RequestFriendModel extends BaseModel<RequestFriend>{
    ...
    static async insertRequestFriend(requestFriend: RequestFriend):Promise<number[]>{
    ...
    static async updateRequestFriend(id: number, requestFriend: RequestFriend):Promise<number>{
